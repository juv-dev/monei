...
const steps = [
  {
    ...
    description:
      'Tu plataforma de finanzas personales. Aquí puedes controlar tus ingresos, gastos, deudas y tarjetas de crédito en un solo lugar.',
  },
  {
    icon: PiggyBank,
    color: '#2D9F8F',
    ...
    description:
      'Hemos cargado datos de ejemplo para que explores la plataforma: ingresos, gastos por categoría, deudas y tarjetas de crédito.',
  },
  {
    icon: BarChart3,
    color: '#4285F4',
    title: 'Dashboard',
    description:
      'En el dashboard verás un resumen general de tus finanzas: balance, ingresos vs gastos, y tus últimos movimientos.',
  },
  {
    icon: CreditCard,
    color: '#8B5CF6',
  ...
  <Teleport to="body">
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-[420px] overflow-hidden">
        ...
        <!-- Close button -->
        <button class="absolute top-4 right-4 text-[#94A3B8] hover:text-[#64748B] z-10" @click="finish">
          <X :size="18" />
        </button>
        ...
        <div class="p-8 text-center">
          ...
          >
            <component :is="steps[currentStep]!.icon" :size="24" :style="{ color: steps[currentStep]!.color }" />
          </div>
        ...
        <div class="flex items-center justify-between px-8 pb-6">
          ...
          <button class="flex items-center gap-1 text-sm font-medium text-[#2D9F8F] hover:text-[#268F80]" @click="next">
